    ...
    <>
      ...
      <div className="card-grid">
        ...
        <div className="stat-card">
          ...
          {data?.review_statistics?.distribution && (
            <div style={{ marginTop: 12, paddingTop: 12, borderTop: '1px solid #e2e8f0', fontSize: '12px', color: '#666' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 4 }}>
                <span>⭐⭐⭐⭐⭐</span>
                <span style={{ fontWeight: 600 }}>{data.review_statistics.distribution[5]}</span>
              </div>
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 4 }}>
                <span>⭐⭐⭐⭐</span>
                <span style={{ fontWeight: 600 }}>{data.review_statistics.distribution[4]}</span>
              </div>
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 4 }}>
                <span>⭐⭐⭐</span>
                <span style={{ fontWeight: 600 }}>{data.review_statistics.distribution[3]}</span>
              </div>
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 4 }}>
                <span>⭐⭐</span>
                <span style={{ fontWeight: 600 }}>{data.review_statistics.distribution[2]}</span>
              </div>
              <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                <span>⭐</span>
                <span style={{ fontWeight: 600 }}>{data.review_statistics.distribution[1]}</span>
              </div>
            </div>
          )}
        </div>
